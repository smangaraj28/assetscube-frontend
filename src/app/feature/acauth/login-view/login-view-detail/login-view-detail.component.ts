...
import {FormBuilder, FormGroup, FormControl, FormArray, Validators, NgForm, FormGroupDirective} from '@angular/forms';
import {ErrorStateMatcher} from '@angular/material';
import {Store, Select, Actions} from '@ngxs/store';
import {LoginSuccess, CheckSession, SessionExists, LoginFailed} from '../../state/auth.actions';
    ...
    ngOnInit() {
        ...
        this.router.events.subscribe((event: Event) => {
            if (event instanceof NavigationEnd) {
                ...
                this.allParams = this.route.snapshot.queryParams; // allParams is an object
                this.set_links(this.allParams);
                if (this.allParams.error === 'true' && this.allParams.comp === this.usertype) {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    set_error_on_renav() {
        ...
        console.log(this.fauthserv.reload_err_msg);
